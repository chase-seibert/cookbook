\section{Ocean Park's Famous Ham and Cheese Italian}
\begin{recipe}

\pre{
    The specific bread roll is less important than the compression of the bread by wrapping it. Classic ham without a rind is preferable. 
    White american cheese is typically behind the deli counter. 
}
