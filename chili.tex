...
\pre{
    The trick to great chili is to toast the chili powder in a generous amount of hot fat. The flavor compounds in chili powder are fat soluble; you will extract the best flavor from them this way.
    For the same reason, you want beef with a high fat content, not 90+ percent lean.
}
